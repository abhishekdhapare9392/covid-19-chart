          ...
          <div class="container-fluid text-center">
            ...
            <div id="popup_default" class="popup">
              ...
              <div class="popup-content">
                <h1>FAQ's</h1>
                <strong>Are you official?</strong>
                <p>No!</p>
                <strong>Who are you ?</strong>
                <p>We are responsible citizen of the country to keep the masses updated with the CORONA Virus
                  infections.</p>
            ...
            <p class="no-margin-bottom">&copy; 2020 <a href="#"
                class="btn btn-primary open-popup" data-id="popup_default" data-animation="scale">FAQ's</a></p>
          </div>
        </div>
      </footer>
    </div>
